...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', this[i].getAttribute('data-target').slice(1)); // btns = {count: num, сколько кнопок
    //     settings[
    //         [text in, classNames=[], close, callBack]
    //     ]
    // }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.html = function (content) {
  ...
  return this;
}; //выбор одного элемента по номеру
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.index = function () {
  ...
  const childs = [...parent.children]; //html коллекция в массив
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.myClosest = function (selector) {
  let counter = 0;

  for (let i = 0; i < this.length; i++) {
    this[i] = this[i].closest(selector); //если селектор не найден?
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.anumateOverTime = function (dur, cb, fin) {
  let timeStart;

  function _anumateOverTime(time) {
    if (!timeStart) {
      timeStart = time;
    }
    ...
    if (timeElapsed < dur) {
      requestAnimationFrame(_anumateOverTime);
    } else {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeIn = function (dur, display, fin) {
  for (let i = 0; i < this.length; i++) {
    ...
    const ani = this.anumateOverTime(dur, _fadeIn, fin);
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeOut = function (dur, fin) {
  for (let i = 0; i < this.length; i++) {
    ...
    const ani = this.anumateOverTime(dur, _fadeOut, fin);
    requestAnimationFrame(ani);
  }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-count="second"]').on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(2).fadeToggle(2000);
});
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').eq(2).on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.w-500').fadeToggle(2000);
});
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    count: 3,
    settings: [['Close', //надпись кнопки
    ['btn_danger', 'mr-10'], //классы 
    true //будет закрывать?
    ], ['Save changes', ['btn_success'], false, () => {
      alert('данные сохранены'); //что будет делать
    }], ['Another btn', ['btn_warning', 'ml-10'], false, () => {
      alert('другая кнопка');
    }]]
  }
}));
